...
var Grid = (function () {
    ...
    Grid.prototype.custom1 = function (row, confirmEmitter) {
        var _this = this;
        var deferred = new Deferred();
        if (this.getSetting('custom1.confirmCustom1')) {
            confirmEmitter.emit({
                data: row.getData(),
                source: this.source,
                confirm: deferred,
    ...
    Grid.prototype.custom2 = function (row, confirmEmitter) {
        var _this = this;
        var deferred = new Deferred();
        if (this.getSetting('custom2.confirmCustom2')) {
            confirmEmitter.emit({
                data: row.getData(),
                source: this.source,
                confirm: deferred,
    ...
    Grid.prototype.custom3 = function (row, confirmEmitter) {
        var _this = this;
        var deferred = new Deferred();
        if (this.getSetting('custom3.confirmCustom3')) {
            confirmEmitter.emit({
                data: row.getData(),
                source: this.source,
                confirm: deferred,
    ...
    Grid.prototype.custom4 = function (row, confirmEmitter) {
        var _this = this;
        var deferred = new Deferred();
        if (this.getSetting('custom4.confirmCustom4')) {
            confirmEmitter.emit({
                data: row.getData(),
                source: this.source,
                confirm: deferred,
    ...
    Grid.prototype.custom5 = function (row, confirmEmitter) {
        var _this = this;
        var deferred = new Deferred();
        if (this.getSetting('custom5.confirmCustom5')) {
            confirmEmitter.emit({
                data: row.getData(),
                source: this.source,
                confirm: deferred,
    ...
    Grid.prototype.custom6 = function (row, confirmEmitter) {
        var _this = this;
        var deferred = new Deferred();
        if (this.getSetting('custom6.confirmCustom6')) {
            confirmEmitter.emit({
                data: row.getData(),
                source: this.source,
                confirm: deferred,
    ...
    Grid.prototype.custom7 = function (row, confirmEmitter) {
        var _this = this;
        var deferred = new Deferred();
        if (this.getSetting('custom7.confirmCustom7')) {
            confirmEmitter.emit({
                data: row.getData(),
                source: this.source,
                confirm: deferred,
