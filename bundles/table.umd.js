...
var Grid = (function () {
    ...
    Grid.prototype.isActionsVisible = function () {
        return this.getSetting('actions.add') || this.getSetting('actions.edit') || this.getSetting('actions.delete') || this.getSetting('actions.custom1') || this.getSetting('actions.custom2') || this.getSetting('actions.custom3') || this.getSetting('actions.custom4') || this.getSetting('actions.custom5') || this.getSetting('actions.custom6') || this.getSetting('actions.custom7') || this.getSetting('actions.custom').length;
    };
...
var Ng2SmartTableTbodyComponent = (function () {
    function Ng2SmartTableTbodyComponent() {
        ...
        this.custom1 = new _angular_core.EventEmitter();
        this.custom2 = new _angular_core.EventEmitter();
        this.custom3 = new _angular_core.EventEmitter();
        this.custom4 = new _angular_core.EventEmitter();
        this.custom5 = new _angular_core.EventEmitter();
        this.custom6 = new _angular_core.EventEmitter();
        this.custom7 = new _angular_core.EventEmitter();
        this.edited = new _angular_core.EventEmitter();
...
var TbodyEditDeleteComponent = (function () {
    ...
    TbodyEditDeleteComponent.prototype.ngOnChanges = function () {
        ...
        this.custom2RowButtonContent = this.grid.getSetting('custom2.custom1ButtonContent');
        this.custom3RowButtonContent = this.grid.getSetting('custom3.custom1ButtonContent');
        this.custom4RowButtonContent = this.grid.getSetting('custom4.custom1ButtonContent');
        this.custom5RowButtonContent = this.grid.getSetting('custom5.custom1ButtonContent');
        this.custom6RowButtonContent = this.grid.getSetting('custom6.custom1ButtonContent');
        this.custom7RowButtonContent = this.grid.getSetting('custom7.custom1ButtonContent');
    };
...
__decorate$40([
    _angular_core.Output(),
    __metadata$34("design:type", Object)
], Ng2SmartTableComponent.prototype, "custom1", void 0);
__decorate$40([
    _angular_core.Output(),
    __metadata$34("design:type", Object)
], Ng2SmartTableComponent.prototype, "custom2", void 0);
__decorate$40([
    _angular_core.Output(),
    __metadata$34("design:type", Object)
], Ng2SmartTableComponent.prototype, "custom3", void 0);
__decorate$40([
    _angular_core.Output(),
    __metadata$34("design:type", Object)
